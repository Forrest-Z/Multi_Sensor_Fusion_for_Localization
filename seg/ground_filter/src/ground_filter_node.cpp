 ...
 */
#include "../include/ground_filter.h"
...
GroundFilter::GroundFilter(ros::NodeHandle &nh, ros::NodeHandle &nh_local) : nh_(nh), nh_local_(nh_local)
{
    updateParams();
    sub_ = nh_.subscribe(topic_str_, 1, &GroundFilter::callBack, this);
...
void GroundFilter::updateParams()
{
...
void GroundFilter::callBack(const sensor_msgs::PointCloud2ConstPtr fused_cloud)
{
...
void GroundFilter::extractInitialSeeds(pcl::PointCloud<pcl::PointXYZI> &in_cloud)
{
...
void GroundFilter::estimatePlane()
{
    Eigen::Matrix3f cov;
    Eigen::Vector4f mean;
...
void GroundFilter::paperMethod(pcl::PointCloud<pcl::PointXYZI> &in_cloud)
{
    // TicToc tt;
    // tt. tic();
